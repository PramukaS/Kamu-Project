...
<head>
	...
	<h1>Kamu.lk Food Library</h1><br>
		<div class="small-container">
			<img src="images/blog/Food1.jpg">
			<div class="text"><h3>Chorizo & mozzarella gnocchi bake <span style="font-size: 16px">  &#8287 &#8287 &#8287  &#8287 &#8287 &#8287 &#8287 &#8287 &#8287 Date:- 15th Nov</span></h3>
			<p style="font-size: 16px"> Author: Pramuka Senaviratna</p>
			...
			<br><button onclick="myFunction()" id="myBtn">More</button>

			<img src="images/blog/Food2.jpg">
			<div class="text">
		    <h3>Lasagna <span style="font-size: 16px">  &#8287 &#8287 &#8287  &#8287 &#8287 &#8287 &#8287 &#8287 &#8287 Date:- 12th Nov</span></h3>
		    <p style="font-size: 16px"> Author: Shifna Shafeek</p>
			<p>For this recipe, we are essentially making a thick, meaty tomato sauce and layering that with noodles and cheese into a casserole. Here’s the run-down:<br>
			...
			<p style="font-size: 16px"> Author: Pathika Weererathna</p>
			<p>For this recipe, we are essentially making a thick, meaty tomato sauce and layering that with noodles and cheese into a casserole. Here’s the run-down:<br>
			Start by making the sauce with ground beef, bell peppers, onions, and a combo of tomato sauce, tomato paste, and crushed tomatoes. The three kinds of tomatoes gives the sauce great depth of flavor.
			<span id="dots">...</span><span id="more">Let this simmer while you boil the noodles and get the cheeses ready. We’re using ricotta, shredded mozzarella, and parmesan — like the mix of tomatoes, this 3-cheese blend gives the lasagna great flavor!<br>
			From there, it’s just an assembly job. A cup of meat sauce, a layer of noodles, more sauce, followed by a layer of cheese. Repeat until you have three layers and have used up all the ingredients. <br> <br>
			...
			<p style="font-size: 16px"> Author: Juzly Ahamed</p>
