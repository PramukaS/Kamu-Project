...
if (isset($_POST['submit2']))
    {
        ...
        if ($isUpdate == true) {
            $sql = "UPDATE food SET id='$id',foodName='$categoryName',calories='$calories',protein='$protein',fat='$fat'  WHERE id=$id";
                    ...
                    <div class="form-group">
                        <label>Food Name</label>
                            <input class="form-control" type="text" name="foodName" size="50"
                                value="<?php echo"$fName" ?>" placeholder="Enter Food Name Here" required><br>
